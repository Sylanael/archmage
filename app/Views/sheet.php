...
<html lang="en">
  ...
  <div class="row">
        <div class="col-4 collumSeperator">
          
            <div class="row marginauto">
              <h2 class="h2-overwrite">One Unique Thing</h2>
            </div>
            <div class="row marginauto">
              <textarea name="" rows="3" cols="40" class="textareaBackgrounds"> </textarea>
            </div>
            ...
            <div class="row marginauto">
             ...
             <div class="padding-row-quater"></div>
              ...
              <div class="row marginauto">
              <h2 class="h2-overwrite">Talents & Features</h2>
              </div>
              <div class="row borderBox">
                ...
                <p>
                  ...
                  Whenever you attack a staggered enemy that you were not engaged with at the state of your turn, you deal +2d6 damage to that creature if you hit.
                </p>

                <p>
                  <strong>Barbaric Cleave: </strong>
                  Once per battle as a free action, make another melee attack after you have dropped a non book foe to 0 health. Dropping the last mook of a book mob also qualifies to use Barbaric Cleave.
                </p>
              </div>
