...
<header>
	<div class="menu">
		<ul>
			<li class="logo"><a href="https://codeigniter.com" target="_blank"></a></li>
			<li class="menu-item hidden"><a href="#">Home</a></li>
			<li class="menu-item hidden"><a href="#" target="_blank">Community</a></li>
			<li class="menu-item hidden"><a href="#" target="_blank">Contribute</a></li>
		</ul>
	</div>
	...
	<div class="heroe">
		...
		<h1>Welcome</h1>
		<h2>just a bunch of random RPG hacks</h2>
